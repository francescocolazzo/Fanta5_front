...
export function CartPanel() {
  ...
  return (
    <div className="fixed bg-slate-800 right-4 top-24 p-3 rounded-xl shadow-2xl w-96 opacity-95">
      ...
      <div className="flex justify-end text-xl font-bold my-3">Total: € {totalCartItems}</div>
